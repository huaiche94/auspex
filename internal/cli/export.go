...
// engine wiring.
//
// Output modes (FR-160/161 machine-output discipline):
...
//     stable auspex.calibration-export-summary.v1 JSON line (row counts,
//     labeling/actual coverage) — the summary a script wants after
//     redirecting the bulk data to a file.
func NewExportCmd(exporter CalibrationExporter) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "export",
